...
class Annotator:
    ...
    def draw_region(self, reg_pts=None, color=(0, 255, 0), thickness=5):
        ...
        """
        for y in range(reg_pts[0][1], reg_pts[2][1], 15):
            cv2.line(self.im, (reg_pts[0][0], y), (reg_pts[1][0], y + 15), color=(0, 255, 255), thickness=3)
        cv2.polylines(self.im, [np.array(reg_pts, dtype=np.int32)], isClosed=True, color=color, thickness=3)
    
    def draw_region_2(self, reg_pts=None, color=(0, 255, 0), thickness=5):
        """
        Draw region line
        Args:
            reg_pts (list): Region Points (for line 2 points, for region 4 points)
